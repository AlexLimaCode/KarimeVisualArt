...
<body>
	...
	<section id="galeria" class="container">
        <div class="text-center">
            <h1 style="color:white;">OBRAS DE LA SECCION DE GRABADO</h1>
		...
		<div class="row">
			...
			$query = "select RutaImagen, nomObra, o.IdObra from tblimagenes i, tblobrasarte o, tbltiposobras t where o.CveTipo = t.CveTipo and i.IdObra = o.IdObra and t.Nomtipo='Grabado' and o.CveEstatus=1 group by nomObra order by o.IdObra";
				...
				$anterior="";
                    while($row=mysqli_fetch_array($result)){
                        if($row[2]==$anterior){
                            ...
                            echo	"<a href=muestraObra.php?IdObra=".$row[2]."&NomTipo=Grabado><img src='../images/obras/".$row[0]."'></a>";
